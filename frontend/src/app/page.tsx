...
const EXPLORER_PROJECTS = [
  ...
  { symbol: "FTT", name: "FTX Token", score: 100, reason: "HOLDER EXODUS", velocity: "Terminal", halfLife: "Dead", sustainability: "0.00", trend: [-80, -95, -99, -100, -100], icon: "https://s2.coinmarketcap.com/static/img/coins/64x64/3168.png", drawdown: "-99.5%", summary: "Catastrophic loss of utility and backing. Collapsed due to centralized fraud and immediate holder capitulation." },
  { symbol: "LUNA", name: "Terra", score: 100, reason: "MARKET COLLAPSE", velocity: "Terminal", halfLife: "Dead", sustainability: "0.00", trend: [-40, -90, -100, -100, -100], icon: "https://s2.coinmarketcap.com/static/img/coins/64x64/20314.png", drawdown: "-99.9%", summary: "Algorithmic depeg caused hyper-inflationary minting, wiping out $40B in market cap within a matter of days." },
